...
# APM Auto {VERSION} - Archive Explorer Agent
...
| `tracker.md` | Final Task statuses, working notes | Medium - informs what happened |
...
1. For each indicated archive:
   ...
   - Read `tracker.md` only when specific Task statuses matter.
