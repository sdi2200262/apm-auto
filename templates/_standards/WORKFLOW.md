...
**No nested subagents** - Claude Code subagents cannot spawn other subagents. Task dispatch subagents iterate within their own context when debugging. If iteration stalls, they return with Partial status and detailed diagnostics. The Manager handles escalation by spawning a fresh investigation subagent or investigating directly.
